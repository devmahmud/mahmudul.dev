...
<Image src={labeledImages} alt="Labeling" class="md:w-1/2 md:h-1/2 self-center" />
<Caption index="4" caption="The labeling process was a little tedious, but it was worth it in the end." />
